...
(function() {
    ...
    win.innerHTML = `
        <div id="chat-widget-header">Юридический ассистент</div>
        <div id="chat-widget-messages"></div>
        <form id="chat-widget-input">
            <input type="text" placeholder="Введите сообщение..." autocomplete="off" />
    ...
    inputForm.onsubmit = async function(e) {
        ...
        try {
            ...
            messages.lastChild.innerHTML = `<span style="display:inline-block;max-width:80%;padding:8px 12px;border-radius:12px;background:#eee;color:#222;">Ошибка соединения с сервером.</span>`;
        }
    };
})()